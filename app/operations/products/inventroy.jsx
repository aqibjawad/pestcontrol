        ...
        return (
            <div className={tableStyles.tableContainer}>
                <table className="min-w-full bg-white">
                    <thead>
                        <tr>
                            <th className="py-5 px-4 border-b border-gray-200 text-left"> Serial Number </th>
                            ...
                            <th className="py-2 px-4 border-b border-gray-200 text-left"> Uses </th>
        ...
        <div>
            <div className="grid grid-cols-12 gap-4">
                <div className="col-span-6">
                    <img src="/inventroy.png" style={{width:"269px", height:"493px", left:"315px" }} />
                </div>
                <div className="col-span-6">
                    <div className="grid grid-cols-12">
                        <div className="col-span-6">
                            ...
                            <div style={{ fontWeight: "600", fontSize: "16px", marginTop: '1.5rem' }}>
                                SKU
                            </div>
