            ...
            <table className="min-w-full bg-white">
                <thead>
                    <tr>
                        ...
                        <th className="py-2 px-4 border-b border-gray-200 text-left"> SKU  </th>
                        <th className="py-2 px-4 border-b border-gray-200 text-left"> Sales Pric </th>
                        <th className="py-2 px-4 border-b border-gray-200 text-left"> Quantity </th>
                        <th className="py-2 px-4 border-b border-gray-200 text-left"> Total Stock </th>
                        <th className="py-2 px-4 border-b border-gray-200 text-left"> Used </th>
                        <th className="py-2 px-4 border-b border-gray-200 text-left"> Current Stock </th>
    ...
    return (
        <div>
            <div style={{ padding: "30px", borderRadius: "10px" }}>
                <div style={{ fontSize: "20px", fontFamily: "semibold", marginBottom: "-4rem" }}>Inventory</div>
                <div className="flex">
