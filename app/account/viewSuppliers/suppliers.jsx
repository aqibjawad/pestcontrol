            ...
            <table className="min-w-full bg-white">
                <thead>
                    <tr>
                        ...
                        <th className="py-2 px-4 border-b border-gray-200 text-left"> Supplier Type </th>
                        <th className="py-2 px-4 border-b border-gray-200 text-left"> TRN </th>
                        <th className="py-2 px-4 border-b border-gray-200 text-left"> VAT </th>
                        <th className="py-2 px-4 border-b border-gray-200 text-left"> HSN </th>
