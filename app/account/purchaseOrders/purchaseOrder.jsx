            ...
            <table className="min-w-full bg-white">
                <thead>
                    <tr>
                        ...
                        <th className="py-2 px-4 border-b border-gray-200 text-left"> Supplier  </th>
                        <th className="py-2 px-4 border-b border-gray-200 text-left"> Payment Type </th>
                        <th className="py-2 px-4 border-b border-gray-200 text-left"> Zip Code </th>
                        <th className="py-2 px-4 border-b border-gray-200 text-left"> Order Date </th>
                        <th className="py-2 px-4 border-b border-gray-200 text-left"> Delivery Date </th>
    ...
    return (
        <div>
            <div style={{ padding: "30px", borderRadius: "10px" }}>
                <div style={{ fontSize: "20px", fontFamily: "semibold", marginBottom: "-4rem" }}> Purchase Order </div>
                <div className="flex">
                ...
                <div className="flex">
                    ...
                    <div className="flex" style={{ display: "flex", alignItems: "center" }}>
                        ...
                        <div style={{ marginTop:"2rem", backgroundColor: "#32A92E", color: 'white', fontWeight: '600', fontSize: "16px", height: "44px", width: "202px", display: "flex", justifyContent: "center", alignItems: "center", marginLeft: "1rem", padding: "12px, 16px, 12px, 16px", borderRadius: "10px" }}>
                            Download all
                        </div>

                        <div 
                            style={{ marginTop: "2rem", backgroundColor: "black", color: 'white', fontWeight: '600', 
                            fontSize: "16px", marginLeft: "auto", marginRight: "auto", height: "44px", width: "60px", display: "flex", 
                            justifyContent: "center", alignItems: "center", 
                            marginLeft: "1rem", cursor: "pointer", borderRadius:"10px" 
                            }}>
                            <Link href="/">
                                Add
                            </Link>
