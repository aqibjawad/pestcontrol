    ...
    return (
        <div className={tableStyles.tableContainer}>
            <table className="min-w-full bg-white">
                <thead>
                    <tr>
                        <th className="py-5 px-4 border-b border-gray-200 text-left"> Porduct </th>
                        ...
                        <th className="py-2 px-4 border-b border-gray-200 text-left"> De;ivery Date </th>
    ...
    return (
        <div>
            <div style={{ padding: "30px", borderRadius: "10px" }}>
                <div style={{ fontSize: "20px", fontFamily: "semibold", marginBottom: "-4rem" }}> Suppliers </div>
                <div className="flex">
                ...
                <div style={{ display: "flex", justifyContent: "flex-end", marginTop: "2rem" }}>
                    ...
                    <div style={{ marginTop: "2rem", backgroundColor: "#32A92E", color: 'white', fontWeight: '600', fontSize: "16px", marginLeft: "auto", marginRight: "auto", height: "48px", width: "150px", display: "flex", justifyContent: "center", alignItems: "center", marginLeft: "1rem", cursor: "pointer" }}>
                        Add
                    </div>
